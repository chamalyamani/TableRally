...
class games(models.Model):
    ...
    p1_id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='player1')
    p2_id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='player2')
    win_id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='win_id')
